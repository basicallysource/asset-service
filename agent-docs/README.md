...
Public-safe, repository-wide documentation for agents and external
contributors. It should be accurate for a fresh contributor with no private
context, and should not carry credentials, personal information, or
deployment-specific detail.

- [`architecture.md`](architecture.md) -- the committed design, the invariants
